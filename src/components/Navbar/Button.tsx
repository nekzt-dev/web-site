  ...
  return (
    ...
    >
      ...
      <div className="w-5 h-5 flex relative items-center justify-center">
        <div className="bg-white w-6 h-6 z-10 absolute rounded-full opacity-20 animate-ping"></div>
        <div className="bg-white w-4 h-4 z-20 absolute rounded-full opacity-20"></div>
